...
**Dataset:** 7 runs collected, 11,502 total 10-Hz telemetry ticks.
...
|---|---|---|---|
| Aggregate Throughput (Mbps) | 198.86 ± 3.49 | 79.96 ± 0.25 | +148.7% |
| Mean Latency (ms) | 31.76 ± 2.47 | 71.20 ± 2.05 | -55.4% |
| 95th-Pct Latency (ms) | 51.28 ± 7.77 | 94.80 ± 2.24 | — |
...
| Residual CFO open-loop  (Hz) | 810.80 | 854.20 | 858.60 |
| Residual CFO closed-loop (Hz) | 72.10 | 76.60 | 76.90 |
...
|---|---|---|---|
| One-way Delay (ms) | 32.66 ± 8.55 | 4.20 ± 1.48 | -87.2% |
| Packet Loss (%) | 0.501 ± 0.829 | 1.1 ± 3.1 | +113.4% |
| Jitter / mdev (ms) | 1.31 ± 0.34 | 4.73 ± 8.77 | +261.8% |
